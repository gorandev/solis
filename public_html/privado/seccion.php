...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<div id="cuerpo">
			<a href="<? echo $back; ?>.php" class="volver">Volver</a>
...
<?
	$sopa=mysqli_query($bdd_link,"select * from productos WHERE sx='$sx'");
	$filasDevueltas = mysqli_num_rows($sopa);
	if ($filasDevueltas!=0){
		$query= "select * from productos WHERE sx='$sx' ORDER BY orden ASC";
