 ...
 */
	session_start();
	if ($_SESSION['tmptxt'] == strtoupper($_POST['captcha'])) {
...
class ProcessForm
{
    ...
    function process()
    {
		...
		$to      = 'info@crucerodesolis.com.ar';
		$subject    = $tipo." desde el sitio web ".$sitio;
        $msg = "Formulario de $tipo: \n\n";
        foreach($this->fields as $key => $field)
              $msg .= ucwords($key)." :  $field \n";
