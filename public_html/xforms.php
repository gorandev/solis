	...
	offset: [30, 0]
          ...
          <div id="field3-container" class="field f_100 checkbox-group required">
               ...
               <div class="option clearfix">
                    <input name="productos[]" id="field3-1" value="<? echo $secciones["3"]["titulo"]; ?>" type="checkbox">
                    <span class="option-title">
                         <? echo $secciones["3"]["titulo"]; ?>
                    </span>
                    <br>
               </div>
               ...
               <div class="option clearfix">
                    <input name="productos[]" id="field3-2" value="<? echo $secciones["4"]["titulo"]; ?>" type="checkbox">
                    <span class="option-title">
                         <? echo $secciones["4"]["titulo"]; ?>
                    </span>
                    <br>
               </div>
               ...
               <div class="option clearfix">
                    <input name="productos[]" id="field3-3" value="<? echo $secciones["5"]["titulo"]; ?>" type="checkbox">
                    <span class="option-title">
                         <? echo $secciones["5"]["titulo"]; ?>
                    </span>
                    <br>
               </div>
               ...
               <div class="option clearfix">
                    <input name="productos[]" id="productos-4" value="<? echo $secciones["6"]["titulo"]; ?>" type="checkbox">
                    <span class="option-title">
                         <? echo $secciones["6"]["titulo"]; ?>
                    </span>
                    <br>
               </div>
               ...
               <div class="option clearfix">
                    <input name="productos[]" id="productos-5" value="<? echo $secciones["7"]["titulo"]; ?>" type="checkbox">
                    <span class="option-title">
                         <? echo $secciones["7"]["titulo"]; ?>
                    </span>
                    <br>
               </div>
               ...
               <div class="option clearfix">
                    <input name="productos[]" id="productos-6" value="<? echo $secciones["8"]["titulo"]; ?>" type="checkbox">
                    <span class="option-title">
                         <? echo $secciones["8"]["titulo"]; ?>
                    </span>
                    <br>
               </div>
          </div>
